        ...
        <div class="col-lg-12">
            <div class="card stretch stretch-full">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold mb-1">Edit Employee: {{ $user->name }}</h5>
                        <span class="fs-12 text-muted">Update employee information and role</span>
                    </div>
...
<div class="col-lg-6 mb-4">
    ...
    <div class="d-flex align-items-center gap-3">
        <div style="width:56px;height:56px;border-radius:50%;overflow:hidden;background:#f1f5f9;display:flex;align-items:center;justify-content:center;flex-shrink:0;border:1px solid #e2e8f0;">
            @if($user->photo)
                <img id="photoPreview" src="{{ $user->photo_url }}" style="width:100%;height:100%;object-fit:cover;">
            @else
                <img id="photoPreview" src="" style="width:100%;height:100%;object-fit:cover;display:none;">
            @endif
            <i class="feather-user" id="photoPlaceholder" style="color:#94a3b8;font-size:20px;{{ $user->photo ? 'display:none;' : '' }}"></i>
        </div>
...
<div class="col-lg-6 mb-4">
    ...
    <div class="input-group">
        ...
        <input type="text" name="employee_id" id="employee_id" class="form-control" value="{{ $user->employee_id }}" placeholder="e.g. EMP-0001">
    </div>
...
<div class="col-lg-6 mb-4">
    ...
    <div class="input-group">
        ...
        <input type="text" name="employee_code" id="employee_code" class="form-control" value="{{ $user->employee_code }}" placeholder="e.g. SWS25">
    </div>
...
<div class="col-lg-6 mb-4">
    ...
    <div class="input-group">
        ...
        <input type="text" name="agent_no" id="agent_no" class="form-control" value="{{ $user->agent_no }}" placeholder="e.g. AGT-1023">
    </div>
        ...
        <select name="business_location_id" id="business_location_id" class="form-control">
            ...
            @foreach($locations as $location)
                <option value="{{ $location->id }}"
                    {{ $user->business_location_id == $location->id ? 'selected' : '' }}>
    ...
    <div class="field-error" id="date_of_joiningError"></div>
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary" id="submitBtn">
                                ...
                                <span id="btnText">Update Employee</span>
                            </button>
                        </div>
...
/* ── Live photo preview when a new file is chosen ── */
document.getElementById('photo')?.addEventListener('change', function () {
    ...
    reader.onload = e => {
        ...
        // if a new photo is chosen, uncheck "remove photo" so they don't conflict
...
employeeCodeInput.addEventListener('input', function () {
    ...
    codeCheckTimer = setTimeout(() => {
        fetch(`{{ route('users.checkEmployeeCode') }}?employee_code=${encodeURIComponent(code)}&exclude_id=${currentUserId}`, {
...
document.getElementById('editUserForm').addEventListener('submit', function(e) {
    ...
    // Laravel method spoofing: keep the actual HTTP verb as POST so PHP parses
    // the multipart body correctly, but tell Laravel to route it as PUT.
    ...
    fetch("{{ route('users.update', $user) }}", {
        ...
        body: formData, // do NOT JSON.stringify and do NOT set Content-Type manually
    })
