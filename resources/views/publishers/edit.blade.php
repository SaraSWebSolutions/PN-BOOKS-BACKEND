...
<div class="page-header">
    <div class="page-header-left d-flex align-items-center">
        <div class="page-header-title">
            <h5 class="m-b-10">Edit Publisher</h5>
        </div>
        <ul class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="card stretch stretch-full">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold mb-1">Edit Publisher: {{ $publisher->publisherProfile->company_name ?? $publisher->name }}</h5>
                        <span class="fs-12 text-muted">Update publisher account and company details</span>
                    </div>

                    <form id="editPublisherForm" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div style="width:56px;height:56px;border-radius:50%;overflow:hidden;background:#f1f5f9;display:flex;align-items:center;justify-content:center;flex-shrink:0;border:1px solid #e2e8f0;">
                                        <img id="photoPreview" src="{{ $publisher->publisherProfile->logo_url ?? '' }}" style="width:100%;height:100%;object-fit:cover;{{ ($publisher->publisherProfile->logo ?? null) ? '' : 'display:none;' }}">
                                        <i class="feather-briefcase" id="photoPlaceholder" style="color:#94a3b8;font-size:20px;{{ ($publisher->publisherProfile->logo ?? null) ? 'display:none;' : '' }}"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        <input type="file" name="logo" id="logo" class="form-control mb-1" accept="image/jpeg,image/png,image/webp">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label fs-12 text-danger" for="remove_photo">Remove current logo</label>
                                        </div>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <input type="email" name="email" id="email" class="form-control" value="{{ $publisher->email }}">
                                <div class="field-error" id="emailError"></div>
                            </div>

                            <div class="col-lg-6 mb-4">
                                <label class="form-label fw-semibold">Mobile Number</label>
                                <input type="text" name="phone" id="phone" class="form-control" value="{{ $publisher->phone }}">
                            ...
                            <div class="col-lg-6 mb-4">
                                <label class="form-label fw-semibold">New Password <span class="text-muted fs-11">(leave blank to keep current)</span></label>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4">
                                ...
                                <input type="text" name="company_name" id="company_name" class="form-control" value="{{ $publisher->publisherProfile->company_name ?? '' }}">
                                <div class="field-error" id="company_nameError"></div>
                            </div>

                            <div class="col-lg-6 mb-4">
                                <label class="form-label fw-semibold">GST Number</label>
                                <input type="text" name="gst_number" id="gst_number" class="form-control" value="{{ $publisher->publisherProfile->gst_number ?? '' }}">
                                <div class="field-error" id="gst_numberError"></div>
                            </div>

                            <div class="col-lg-6 mb-4">
                                <label class="form-label fw-semibold">PAN / Tax ID</label>
                                <input type="text" name="pan_number" id="pan_number" class="form-control" value="{{ $publisher->publisherProfile->pan_number ?? '' }}">
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <select name="verification_status" id="verification_status" class="form-control">
                                    @php $vs = $publisher->publisherProfile->verification_status ?? 'pending'; @endphp
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <input type="text" name="contact_person" id="contact_person" class="form-control" value="{{ $publisher->publisherProfile->contact_person ?? '' }}">
                                <div class="field-error" id="contact_personError"></div>
                            </div>

                            <div class="col-lg-6 mb-4">
                                <label class="form-label fw-semibold">Contact Phone</label>
                                <input type="text" name="contact_phone" id="contact_phone" class="form-control" value="{{ $publisher->publisherProfile->contact_phone ?? '' }}">
                                <div class="field-error" id="contact_phoneError"></div>
                            </div>

                            <div class="col-lg-6 mb-4">
                                <label class="form-label fw-semibold">Contact Email</label>
                                <input type="email" name="contact_email" id="contact_email" class="form-control" value="{{ $publisher->publisherProfile->contact_email ?? '' }}">
                                <div class="field-error" id="contact_emailError"></div>
                            </div>

                            <div class="col-lg-12 mb-4">
                                <label class="form-label fw-semibold">Company Address</label>
                                <textarea name="company_address" id="company_address" class="form-control" rows="2">{{ $publisher->publisherProfile->company_address ?? '' }}</textarea>
                                <div class="field-error" id="company_addressError"></div>
                            </div>
                        </div>

                        <hr>
                        <h6 class="fw-semibold mb-3 text-primary">Payout Details</h6>
                        <div class="row">
                            <div class="col-lg-4 mb-4">
                                <label class="form-label fw-semibold">Bank Account Name</label>
                                <input type="text" name="bank_account_name" id="bank_account_name" class="form-control" value="{{ $publisher->publisherProfile->bank_account_name ?? '' }}">
                                <div class="field-error" id="bank_account_nameError"></div>
                            </div>
                            <div class="col-lg-4 mb-4">
                                <label class="form-label fw-semibold">Bank Account Number</label>
                                <input type="text" name="bank_account_number" id="bank_account_number" class="form-control" value="{{ $publisher->publisherProfile->bank_account_number ?? '' }}">
                                <div class="field-error" id="bank_account_numberError"></div>
                            </div>
                            <div class="col-lg-4 mb-4">
                                <label class="form-label fw-semibold">Bank IFSC / SWIFT</label>
                                <input type="text" name="bank_ifsc" id="bank_ifsc" class="form-control" value="{{ $publisher->publisherProfile->bank_ifsc ?? '' }}">
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary" id="submitBtn">
                                ...
                                <span id="btnText">Update Publisher</span>
                            </button>
                        </div>
...
document.getElementById('editPublisherForm').addEventListener('submit', function(e) {
    ...
    fetch("{{ route('publishers.update', $publisher) }}", {
        method: 'POST',
        headers: {
    ...
    .then(({ status, data }) => {
        ...
        btnText.textContent = 'Update Publisher';
