            ...
            <div class="card stretch stretch-full">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <span class="fs-12 text-muted">Create a new role and assign permissions</span>
                    </div>
                    ...
                    <form id="createRoleForm" novalidate>
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="e.g. accountant, supervisor">
                                </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <h6 class="fw-semibold text-uppercase fs-11 text-muted mb-0">
                                    <i class="feather-key me-2"></i> Assign Permissions
                                </h6>
                            ...
                            <div class="field-error" id="permissionsError"></div>
                        </div>
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary" id="submitBtn">
                                ...
                                <span id="btnText">Create Role</span>
                            </button>
                        </div>
