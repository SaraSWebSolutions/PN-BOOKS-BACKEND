        ...
        <div class="col-lg-12">
            <div class="card stretch stretch-full">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <h5 class="fw-bold mb-1">Edit Author: {{ $author->name }}</h5>
                        <span class="fs-12 text-muted">Update author account and profile details</span>
                    </div>
                    ...
                    <form id="editAuthorForm" novalidate>
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div style="width:56px;height:56px;border-radius:50%;overflow:hidden;background:#f1f5f9;display:flex;align-items:center;justify-content:center;flex-shrink:0;border:1px solid #e2e8f0;">
                                        <img id="photoPreview" src="{{ $author->photo_url ?? '' }}" style="width:100%;height:100%;object-fit:cover;{{ $author->photo ? '' : 'display:none;' }}">
                                        <i class="feather-user" id="photoPlaceholder" style="color:#94a3b8;font-size:20px;{{ $author->photo ? 'display:none;' : '' }}"></i>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="pen_name" id="pen_name" class="form-control" value="{{ $author->authorProfile->pen_name ?? '' }}">
                                </div>
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" name="website" id="website" class="form-control" value="{{ $author->authorProfile->website ?? '' }}">
                                </div>
                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <textarea name="bio" id="bio" class="form-control" rows="3">{{ $author->authorProfile->bio ?? '' }}</textarea>
                                <div class="field-error" id="bioError"></div>
                            </div>

                            <div class="col-lg-6 mb-4">
                                <label class="form-label fw-semibold">Social Links</label>
                                <input type="text" name="social_links" id="social_links" class="form-control" value="{{ $author->authorProfile->social_links ?? '' }}">
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <select name="verification_status" id="verification_status" class="form-control">
                                    @php $vs = $author->authorProfile->verification_status ?? 'pending'; @endphp
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <input type="number" step="0.01" min="0" max="100" name="commission_rate" id="commission_rate" class="form-control" value="{{ $author->authorProfile->commission_rate ?? '' }}">
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-4">
                                ...
                                <input type="text" name="bank_account_name" id="bank_account_name" class="form-control" value="{{ $author->authorProfile->bank_account_name ?? '' }}">
                                <div class="field-error" id="bank_account_nameError"></div>
                            </div>
                            <div class="col-lg-4 mb-4">
                                <label class="form-label fw-semibold">Bank Account Number</label>
                                <input type="text" name="bank_account_number" id="bank_account_number" class="form-control" value="{{ $author->authorProfile->bank_account_number ?? '' }}">
                                <div class="field-error" id="bank_account_numberError"></div>
                            </div>
                            <div class="col-lg-4 mb-4">
                                <label class="form-label fw-semibold">Bank IFSC / SWIFT</label>
                                <input type="text" name="bank_ifsc" id="bank_ifsc" class="form-control" value="{{ $author->authorProfile->bank_ifsc ?? '' }}">
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary" id="submitBtn">
                                ...
                                <span id="btnText">Update Author</span>
                            </button>
                        </div>
...
document.getElementById('editAuthorForm').addEventListener('submit', function(e) {
    ...
    fetch("{{ route('authors.update', $author) }}", {
        method: 'POST',
        headers: {
    ...
    .then(({ status, data }) => {
        ...
        btnText.textContent = 'Update Author';
